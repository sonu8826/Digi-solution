...
import { ArrowRight, Code, Video, Camera, Smartphone, Palette, Zap, Star, Menu, X, ChevronRight, Calendar, Eye, ExternalLink } from 'lucide-react';
...
const DigitalServicesLanding = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ["Retouching", "Color Correction", "Background Removal", "HDR Processing"]
    },
    {
      icon: Smartphone,
      title: "Mobile App Development",
      description: "Native and cross-platform mobile applications",
      features: ["iOS & Android", "React Native", "UI/UX Design", "App Store Deploy"]
    },
    {
      icon: Palette,
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "CEO, TechStart",
      content: "Exceptional work on our website. The team delivered beyond our expectations with a modern, fast-loading site that perfectly represents our brand.",
      rating: 5,
      image: "https://images.unsplash.com/photo-1494790108755-2616b332b3c3?w=64&h=64&fit=crop&crop=face"
    },
    {
      name: "Michael Chen",
      role: "Marketing Director",
      content: "Their video editing skills are top-notch. Our promotional videos now have a professional quality that significantly boosted our engagement.",
      rating: 5,
    ...
    },
    {
      ...
      content: "From concept to launch, the entire process was seamless. They transformed our vision into a stunning digital presence.",
      rating: 5,
  ...
  const latestWork = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1492619392885-1d6f7d7e8e1a?w=600&h=400&fit=crop",
    ...
    },
    {
      ...
      description: "High-end product photography with professional retouching and background optimization.",
    ...
    },
    {
      ...
      description: "Comprehensive digital marketing campaign with social media strategy and performance analytics.",
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        scrollY > 50 ? 'bg-slate-950/95 backdrop-blur-md border-b border-slate-800' : 'bg-transparent'
      }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:block">
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105">
                Get Started
              </button>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-slate-900/95 backdrop-blur-md border-t border-slate-800">
            <div className="px-4 py-4 space-y-4">
              ...
              <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-2 rounded-lg font-medium">
                Get Started
              </button>
            </div>
          </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Transform your digital presence with our cutting-edge services. From stunning websites to captivating videos, we bring your vision to life.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-8 py-4 rounded-lg font-medium text-lg transition-all duration-300 transform hover:scale-105 flex items-center">
              Start Your Project
              <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-8 py-4 rounded-lg font-medium text-lg border border-slate-600 hover:border-slate-400 transition-colors">
              View Our Work
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-purple-500/50 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {latestWork.map((project) => (
              <div key={project.id} className="group bg-slate-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      View Project
                      {project.isExternal && <ExternalLink className="w-3 h-3 ml-1" />}
                    </button>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-slate-400 mb-4 max-w-md">
                Crafting exceptional digital experiences that drive results and inspire growth for businesses worldwide.
              </p>
            </div>
